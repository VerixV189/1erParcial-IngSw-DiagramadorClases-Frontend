...
interface UMLInterfaceData {
  ...
  onUpdate?: (data: UMLInterfaceData) => void
}
...
export const UMLInterfaceNode = memo(({ data }: NodeProps<UMLInterfaceData>) => {
  ...
  return (
    <div className="min-w-[200px]">
      ...
      <Card className="shadow-lg border-2 border-dashed hover:border-primary/50 transition-colors bg-card dark:bg-card">
        <CardHeader className="pb-2 text-center">
          <Badge variant="secondary" className="text-xs mb-1 self-center">
            &lt;&lt;interface&gt;&gt;
          </Badge>
