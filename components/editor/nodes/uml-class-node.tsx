...
interface UMLClassData {
  ...
  onUpdate?: (data: UMLClassData) => void
}
...
export const UMLClassNode = memo(({ data }: NodeProps<UMLClassData>) => {
  ...
  return (
    <div className="min-w-[200px]">
      ...
      <Card className="shadow-lg border-2 hover:border-primary/50 transition-colors bg-card dark:bg-card">
        <CardHeader className="pb-2 text-center">
          ...
          <h3 className="font-bold text-sm">{renderEditableText("name", data.name)}</h3>
        </CardHeader>
